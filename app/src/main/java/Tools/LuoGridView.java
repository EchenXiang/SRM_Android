...
public class LuoGridView extends GridView {
    ...
    public LuoGridView(Context contxt) {
        super(contxt);
    ...
    public LuoGridView(Context contxt, AttributeSet attrs) {
        super(contxt, attrs);
        setChildrenDrawingOrderEnabled(true);
        setClipChildren(false);
        setClipToPadding(false);
    ...
    public LuoGridView(Context contxt, AttributeSet attrs, int defStyle) {
